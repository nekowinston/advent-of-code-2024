...
main =
 ...
 where
  ...
  solvers =
    ...
    , (AOC.Day2.solve1, AOC.Day2.solve2, $(embedStringFile "./data/day1.txt"))
    , (AOC.Day3.solve1, AOC.Day3.solve2, $(embedStringFile "./data/day1.txt"))
    , (AOC.Day4.solve1, AOC.Day4.solve2, $(embedStringFile "./data/day1.txt"))
    ]
